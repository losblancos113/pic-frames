<template>
  <modal name="contact-modal" :adaptive="true">
    <div class="bg-white dark:bg-gray-900 sm:items-center sm:pt-0 mb-8">
            ...
            <div class="p-6 mr-2 bg-gray-100 dark:bg-gray-800 sm:rounded-lg">
              ...
              >
                ...
                <div class="ml-4 text-md tracking-wide font-semibold w-40">
                  164 Lương Định Của Phương Mai Đống Đa Hà Nội
                </div>
              </div>
